...
const ASUNTOS = [
  'Preguntar sobre planes y acceso',
  'Reportar problema con inicio de sesión',
  'Sugerir nuevos colores o recursos',
  'Reportar problema técnico con descargas',
  'Soporte general con WiiTema',
  'Propuesta de colaboración',
  'Otro motivo de contacto',
];

const FAQ = [
  { q: '¿Respondemos todos los mensajes?', r: 'Sí. Cada mensaje se lee y responde de forma personal por el equipo de WiiTema.' },
  { q: '¿WiiTema es gratuito?', r: 'El acceso base es gratuito. Los planes premium ofrecen colecciones exclusivas y herramientas avanzadas.' },
  { q: '¿Tus mensajes son confidenciales?', r: 'Absolutamente. Solo los revisa el equipo de soporte y no se comparten con terceros bajo ninguna circunstancia.' },
  { q: '¿Puedo compartir recursos de WiiTema?', r: 'Puedes usar los recursos en tus proyectos, pero la redistribución masiva requiere autorización. Consulta nuestros términos de licencia.' },
];
