import{n as e}from"./vendor-BuoCFfzO.js";import{t}from"./wii-B7KacVyR.js";import{T as n,_ as r,c as i,h as a,i as o,p as s,r as c,u as l,w as u,y as d}from"./widev-C6_C1nMz.js";import{o as f}from"./index-vmHpfrLD.js";var p=`word_docs`,m=()=>`wd`+Date.now(),h=[{id:`ej1`,titulo:`Documento de Ejemplo`,contenido:`<p>Este es un documento de ejemplo. <b>Prueba a editar el texto</b> y usar las herramientas de la barra superior para darle estilo.</p>`,pin:!0,creado:Date.now(),actualizado:Date.now(),synced:!1}],g={get:()=>{let e=localStorage.getItem(p);return e===null&&!r.user?[...h]:l(p)||(e?.startsWith(`[`)?JSON.parse(e):[])},set:e=>s(p,e,8760)},_=()=>`
<div class="wd_wrap">
  <!-- RIBBON -->
