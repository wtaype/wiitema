import{n as e}from"./vendor-BuoCFfzO.js";import{C as t,S as n,_ as r,p as i,r as a,t as o,u as s}from"./widev-o5MGI85p.js";import{_ as c,b as l,f as u,g as d,l as f,n as p,o as m,r as h,s as g,u as _}from"./firebase-CcGrcE7k.js";import{n as v}from"./firebase-Dp4rAqD-.js";import{cargarTodosEmpleados as y}from"./zsmile-D9ubJ1Ht.js";var b=`.chat`,x=`chatSmileMsgs`,S=.1,C=7,w=5,ee=3e4,T=500,E=[],D=[],O=``,k=null,A=!1,j=``,M=``,N=!1,P=!0,F=null,I=()=>`
...
`;function L(){return[,,,,,].fill(0).map(()=>`
    ...
    <div class="chat_bubble_wrap ${i?`mine`:`other`} chat_msg_in ${e.temp?`chat_msg_pending`:``}" data-id="${e.id||``}">
      ...
      <div class="chat_bubble_col">
        <div class="chat_bubble_meta ${i?`right`:``}">
          <span class="chat_bubble_name">${o(e.nombre||n||`Colaborador`)}</span>
  ...
  `,W=e=>String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`),G=e=>e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),K=()=>{let t=e(`#chatTextarea`).val()||``;e(`.chat_sidebar_item`).each(function(){let n=(e(this).attr(`data-nombre`)||``).trim();n&&(RegExp(`@`+G(n)+`(?![a-zA-Z0-9áéíóúüñÁÉÍÓÚÜÑ])`,`i`).test(t)?e(this).addClass(`active`):e(this).removeClass(`active`))})},q=(t=!1)=>{let n=e(`#chatMessages`);if(!E.length){n.html(`
    ...
    `);return}let r=n.map(e=>{let t=e.usuario===j,n=z(e.nombre||`?`),r=V(e.usuario||``),i=e.estado===`activo`,a=e.imagen||e.avatar,s=a?`<img class="chat_sidebar_avatar_img" src="${a}" alt="${e.nombre}" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">`:``;return`${e.nombre||``} ${e.apellidos||``}`.replace(/\s+/g,` `).trim(),`
      <div class="chat_sidebar_item ${t?`chat_sidebar_item_me`:``}" data-usuario="${e.usuario}" data-nombre="${e.usuario}">
        ...
        <div class="chat_sidebar_info">
          <div class="chat_sidebar_name_row">
            <span class="chat_sidebar_name">${o(e.nombre)} ${o(e.apellidos||``)}</span>
    ...
    `}).join(``);t.html(r),K()},Y=(e=!1)=>{let t=document.getElementById(`chatMessages`);t&&t.scrollTo({top:t.scrollHeight,behavior:e?`smooth`:`auto`})},te=t=>{e(`#chatOnlineCount`).text(t)},X=async(t=!1)=>{if(!N){if(N=!0,!t){let e=s(x);if(e&&Array.isArray(e)){E=e,P=!0,q(),N=!1;return}}t&&e(`#chatRefresh`).addClass(`chat_spinning`),e(`#chatHeader`).addClass(`smw_loading`);try{let e=await m(_(d(v,`chatSmiles`),f(`creado`,`desc`),g(C)));E=e.docs.reverse().map(e=>({id:e.id,...e.data()})),P=e.size>=C,i(x,E,S),q(),te(new Set(E.map(e=>e.usuario||e.autor).filter(Boolean)).size)}catch(t){console.error(`[Chat] loadMensajes error:`,t),E.length||e(`#chatMessages`).html(`
      ...
      `),a(`No se pudieron cargar los mensajes`,`error`)}finally{N=!1,e(`#chatHeader`).removeClass(`smw_loading`),e(`#chatRefresh`).removeClass(`chat_spinning`)}}},ne=async()=>{if(N||!P||!E.length)return;let t=e(`#chatMessages`),n=E[0].creado||E[0].ts;if(!n){a(`No se puede paginar: falta cursor de tiempo`,`warning`);return}N=!0,e(`#chatPaginateBtn`).prop(`disabled`,!0).html(`<i class="fas fa-circle-notch fa-spin"></i> Cargando anteriores...`);try{let e=await m(_(d(v,`chatSmiles`),f(`creado`,`desc`),u(n),g(w)));if(e.empty){P=!1,q(!0),a(`No hay más mensajes anteriores`,`info`);return}let r=e.docs.reverse().map(e=>({id:e.id,...e.data()}));r.length<w&&(P=!1);let i=t[0].scrollHeight,o=t[0].scrollTop;E=[...r,...E],q(!0);let s=t[0].scrollHeight;t[0].scrollTop=o+(s-i),a(`Cargados ${r.length} mensajes anteriores`,`success`)}catch(e){console.error(`[Chat] loadAnteriores error:`,e),a(`Error al cargar anteriores`,`error`)}finally{N=!1}},Z=async()=>{try{D=await y(!0),J()}catch(e){console.error(`[Chat] _loadColaboradores error:`,e)}},Q=async()=>{if(!A)return;let t=e(`#chatTextarea`),n=t.val().trim();if(!n)return;if(n.length>T){a(`El mensaje excede ${T} caracteres`,`warning`);return}t.val(``).trigger(`input`),$(t[0]);let o=`temp_`+Date.now()+Math.random().toString(36).substr(2,5),s=r.user,c=s?.imagen||s?.avatar||``,u={id:o,texto:n,usuario:j,email:s?.email||``,nombre:M,imagen:c,creado:new Date,ts:new Date,tipo:`texto`,temp:!0};E.push(u),q(!1),p(d(v,`chatSmiles`),{texto:n,usuario:j,email:s?.email||``,nombre:M,imagen:c,creado:l(),ts:l(),tipo:`texto`}).then(e=>{let t=E.findIndex(e=>e.id===o);t!==-1&&(E[t].id=e.id,delete E[t].temp,i(x,E,S),q(!0))}).catch(e=>{console.error(`[Chat] Background send error:`,e),a(`No se pudo entregar el mensaje`,`error`),E=E.filter(e=>e.id!==o),i(x,E,S),q(!0)})},$=e=>{e&&(e.style.height=`auto`,e.style.height=Math.min(e.scrollHeight,96)+`px`,e.style.overflowY=e.scrollHeight>96?`auto`:`hidden`)},re=()=>{let t=e(`#chatTextarea`),n=e(`#chatSendBtn`),r=e(`#chatBlockedMsg`);A?(t.prop(`disabled`,!1).attr(`placeholder`,`Escribe un mensaje…`),n.prop(`disabled`,!1).removeClass(`chat_send_disabled`),r.hide()):(t.prop(`disabled`,!0).attr(`placeholder`,`No puedes enviar mensajes (participación inactiva)`),n.prop(`disabled`,!0).addClass(`chat_send_disabled`),r.show())},ie=async()=>{e(`.chat_wrap`).addClass(`visible`),window.__WIREADY__=!0;let t=r.user;t&&(j=t.usuario||t.email||``,M=t.nombre||t.usuario||`Colaborador`,A=t.participa===`si`),re(),X(!1),Z(),k=setInterval(()=>{i(x,null,0),X(!0),Z()},ee),e(document).on(`input${b}`,`#chatTextarea`,function(){$(this),K()}),e(document).on(`keydown${b}`,`#chatTextarea`,function(e){e.key===`Enter`&&!e.shiftKey&&(e.preventDefault(),Q())}),e(document).on(`click${b}`,`#chatSendBtn`,()=>Q()),e(document).on(`click${b}`,`#chatRefresh`,async function(){i(x,null,0),P=!0,await X(!0),await Z(),a(`Mensajes actualizados`,`success`)}),e(document).on(`click${b}`,`#chatPaginateBtn`,()=>ne()),e(document).on(`click${b}`,`.chat_msg_delete_btn`,function(){let t=e(this).attr(`data-id`);t&&(F=t,e(`#chatEliminarModal`).addClass(`show`))}),e(document).on(`click${b}`,`#chatCancelDeleteBtn, #chatEliminarModal`,function(t){e(t.target).is(`#chatCancelDeleteBtn, #chatEliminarModal`)&&(e(`#chatEliminarModal`).removeClass(`show`),F=null)}),e(document).on(`click${b}`,`#chatConfirmDeleteBtn`,async function(){if(!F)return;let t=this;n(t,!0,`Eliminando...`);try{let t=F;await h(c(v,`chatSmiles`,t)),a(`Mensaje eliminado permanentemente`,`success`),e(`#chatEliminarModal`).removeClass(`show`),F=null;let n=e(`.chat_bubble_wrap[data-id="${t}"]`);n.length?n.fadeOut(300,function(){e(this).remove(),E=E.filter(e=>e.id!==t),i(x,E,S)}):(E=E.filter(e=>e.id!==t),i(x,E,S),q(!0))}catch(e){console.error(`[Chat] deleteDoc error:`,e),a(`Error al eliminar mensaje`,`error`)}finally{n(t,!1,`Eliminar`)}}),e(document).on(`input${b}`,`#chatSearchInput`,function(){O=e(this).val(),J()}),e(document).on(`click${b}`,`.chat_sidebar_item`,function(t){if(!A)return;let n=(e(this).attr(`data-nombre`)||``).trim(),r=e(`#chatTextarea`),i=e(this).hasClass(`active`),a=r.val(),o=`@${n}`;if(i){let e=n.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),t=RegExp(`@`+e+`(?![a-zA-Z0-9áéíóúüñÁÉÍÓÚÜÑ])\\s*`,`gi`);a=a.replace(t,``),a=a.replace(/\s+/g,` `).trim(),r.val(a?a+` `:``)}else{let e=a?a.endsWith(` `)?``:` `:``;r.val(a+e+o+` `)}r.trigger(`input`),r.focus(),$(r[0]),e(`#chatContainer`).removeClass(`chat_sidebar_active`)}),e(document).on(`click${b}`,`#chatSidebarToggle`,function(){e(`#chatContainer`).addClass(`chat_sidebar_active`)}),e(document).on(`click${b}`,`#chatSidebarClose`,function(){e(`#chatContainer`).removeClass(`chat_sidebar_active`)}),e(document).on(`click${b}`,`#chatRetry`,()=>{e(`#chatMessages`).html(R()),e(`#chatSidebarList`).html(L()),X(!0),Z()}),e(document).on(`focus${b}`,`#chatTextarea`,function(){setTimeout(()=>Y(!0),350)})},ae=()=>{e(document).off(b),clearInterval(k),k=null,E=[],D=[],O=``,A=!1,j=``,M=``,N=!1,P=!0,F=null};export{ae as cleanup,ie as init,I as render};