...
</style>`;e(`#sm_code_exporter_block`).text(p)},f=e=>{if(!e||typeof e!=`string`)return[0,0,0];e=e.replace(/^#/,``),e.length===3&&(e=e.split(``).map(e=>e+e).join(``));let t=parseInt(e,16);return isNaN(t)?[0,0,0]:[t>>16&255,t>>8&255,t&255]},p=()=>{let e=i(`wiSmile`)||{},r=e.nombre||e.usuario||e.email||``;return`
