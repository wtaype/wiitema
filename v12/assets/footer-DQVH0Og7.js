import{n as e}from"./vendor-BuoCFfzO.js";import{n as t,o as n,s as r,t as i}from"./wii-BxWTwmKJ.js";import{p as a,u as o}from"./widev-DR9cf7O0.js";function s(){return`
  <footer class="foo">
    <div class="foo_inner">
      <div class="foo_left">
        <div class="foo_brand">
        ...
        <div class="foo_links">
          ...
          <div class="foo_right">
          <span>Creado con <i class="fas fa-heart" style="color:var(--mco);"></i> by <a href="${r}" target="_blank"><strong>${t}</strong></a> ${n} - ${new Date().getFullYear()}</span>
          </div>
          </div>
          </footer>
          `}e(`.foo`).length||e(`body`).append(s()),e(`#wi_bg_style`).length||e(`head`).append(`<style id="wi_bg_style">:root{--bgim:url("/wiitema/v12/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>`);var c=`cookies`,l=t=>{a(c,t),e(`#cookies`).removeClass(`cookies_show`),setTimeout(()=>e(`#cookies`).remove(),150)};e(document).on(`pointerdown`,`#ck_aceptar`,()=>l(!0)),e(document).on(`pointerdown`,`#ck_rechazar`,()=>l(!1)),o(c)?e(`#cookies`).remove():(e(`#cookies`).length||e(`body`).append(`
