import{n as e}from"./vendor-BuoCFfzO.js";import{t}from"./wii-B7KacVyR.js";import{p as n,r,u as i}from"./widev-4Rjv6ciq.js";import{D as a,T as o,h as s,x as c}from"./firebase-CTU0UJ6d.js";import{n as l}from"./firebase-DNXHJgUE.js";var u=()=>i(`wiSmile`),d=`amUsersTotal`,f=`amUsersPro`,p=`amOrgsTotal`,m=`amLessonsTotal`,h=()=>{let e=u();return!e||e.rol!==`admin`?`<div class="am_page"><div class="am_empty"><i class="fas fa-ban"></i> Acceso denegado.</div></div>`:`
  <div class="am_page">
