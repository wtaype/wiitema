import{n as e}from"./vendor-BuoCFfzO.js";import{C as t,T as n,r,u as i}from"./widev-CaaaKRDv.js";import{S as a,a as o,c as s,f as c,g as l,i as u,v as d,y as f}from"./firebase-Dw05u4aT.js";import{n as p,t as m}from"./firebase-C7Kevfpd.js";var h=`wiAudios`,g=`wiImg`,_=()=>i(`wiSmile`)?.email||m.currentUser?.email||``,v=async e=>{let t=_();return t?(await s(c(d(p,e),l(`email`,`==`,t)))).docs.map(e=>({id:e.id,...e.data()})).sort((e,t)=>(t.creado?.seconds||0)-(e.creado?.seconds||0)):[]},y=async(e,t,n)=>{let r=_();return r?(await u(d(p,e),{email:r,titulo:t,src:n,creado:a(),actualizado:a()})).id:null},b=async(e,t)=>{await o(f(p,e,t))},x=()=>v(h),S=()=>v(g),C=(e,t)=>`
