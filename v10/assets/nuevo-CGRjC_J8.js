...
import{n as e}from"./vendor-BuoCFfzO.js";import{l as t}from"./wii-B7KacVyR.js";import{C as n,g as r,n as i,r as a,u as o,x as s,y as c}from"./widev-4Rjv6ciq.js";import{i as l}from"./index-Dt5s5XVG.js";import{O as u,S as d,g as f,j as p,w as m}from"./firebase-CTU0UJ6d.js";import{n as h}from"./firebase-DNXHJgUE.js";import{a as g,b as _,o as v,t as y,u as b}from"./devblog-DrVJout3.js";var x=e=>e.trim().toLowerCase().normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).replace(/\b(el|la|los|las|de|del|en|un|una|y|a|con|por|para|que|es|se)\b/g,` `).replace(/[^a-z0-9\s]/g,``).replace(/\s+/g,`_`).replace(/_{2,}/g,`_`).replace(/^_|_$/g,``).slice(0,50),S=e=>{let t=e.replace(/<[^>]*>/g,` `).split(/\s+/).filter(Boolean);return{words:t.length,min:Math.max(1,Math.ceil(t.length/200))}},C=()=>c.params()?.edit||new URLSearchParams(location.search).get(`edit`)||null,w=()=>{let e=r.user?.usuario?r.user:o(`wiSmile`)||{};if(!e.email)return`<div class="nu_err dpvc"><i class="fas fa-lock"></i><h2>Acceso restringido</h2><p>Inicia sesión para crear historias</p></div>`;let i=C();return`
  <div class="nu_wrap">
    <div class="nu_head">
      ...
      <div class="nu_head_right">
        ${i?`<a href="/${i}" class="nu_btn_outline" ${n(`Ver post`)}><i class="fas fa-eye"></i> Ver</a>`:`<button type="button" id="nu_preview_pg" class="nu_btn_outline" ${n(`Preview`)}><i class="fas fa-eye"></i> Preview</button>`}
      ...
      <div class="nu_left">
        <div class="nu_card">
          ...
          <div class="nu_slug_box">
            ...
            ${i?``:`<button type="button" id="nu_slug_reset" class="nu_slug_btn" ${n(`Regenerar`)}><i class="fas fa-rotate"></i></button>`}
          </div>
...
---
`,`Separador`]],[[`fa-code`,"`código`",`Código`],[`fa-image`,`![desc](url)`,`Imagen`],[`fa-link`,`[texto](url)`,`Enlace`]]].map((e,t)=>`<div style="display:flex;gap:0.4vh${t<3?`;border-right:1px solid var(--brd);padding-right:0.6vh;margin-right:0.2vh`:``}">${e.map(([e,t,r])=>`<button type="button" class="nu_tool" data-tag='${t}' ${n(r)}><i class="fas ${e}"></i></button>`).join(``)}</div>`).join(``)}</div>
      ...
      <div class="nu_right">
        ...
        <div class="nu_card">
          ...
          <div style="display:flex; flex-direction:column; gap:1vh; margin-bottom: 1.5vh;">
            ...
            <div id="nu_img_prev" class="nu_img_prev dpn"><img id="nu_img_el" src="" alt=""/><button type="button" id="nu_img_clear" class="nu_img_clear" ${n(`Quitar`)}><i class="fas fa-xmark"></i></button></div>
          </div>
          <div style="display:flex; flex-direction:column; gap:1vh;">
            ...
            <div id="nu_img_top_prev" class="nu_img_prev dpn"><img id="nu_img_top_el" src="" alt=""/><button type="button" id="nu_img_top_clear" class="nu_img_clear" ${n(`Quitar`)}><i class="fas fa-xmark"></i></button></div>
          </div>
        </div>
