import{n as e}from"./vendor-BuoCFfzO.js";import{l as t}from"./wii-B7KacVyR.js";import{S as n,_ as r,b as i,n as a,r as o,u as s,w as c}from"./widev-o5MGI85p.js";import{o as l}from"./index-lKu2lDBp.js";import{_ as u,a as d,b as f,d as p,p as m}from"./firebase-CcGrcE7k.js";import{n as h}from"./firebase-Dp4rAqD-.js";import{a as g,b as _,o as v,t as y,u as b}from"./devblog-BwquuXM1.js";var x=e=>e.trim().toLowerCase().normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).replace(/\b(el|la|los|las|de|del|en|un|una|y|a|con|por|para|que|es|se)\b/g,` `).replace(/[^a-z0-9\s]/g,``).replace(/\s+/g,`_`).replace(/_{2,}/g,`_`).replace(/^_|_$/g,``).slice(0,50),S=e=>{let t=e.replace(/<[^>]*>/g,` `).split(/\s+/).filter(Boolean);return{words:t.length,min:Math.max(1,Math.ceil(t.length/200))}},C=()=>i.params()?.edit||new URLSearchParams(location.search).get(`edit`)||null,w=()=>{let e=r.user?.usuario?r.user:s(`wiSmile`)||{};if(!e.email)return`<div class="nu_err dpvc"><i class="fas fa-lock"></i><h2>Acceso restringido</h2><p>Inicia sesión para crear historias</p></div>`;let n=C();return`
  <div class="nu_wrap">
    <div class="nu_head">
