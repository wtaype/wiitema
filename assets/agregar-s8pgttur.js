import{n as e}from"./vendor-BuoCFfzO.js";import{C as t,r as n,u as r,x as i}from"./widev-DlmvaZ2M.js";import{D as a,O as o,T as s,_ as c,j as l,m as u,p as d,x as f}from"./firebase-CTU0UJ6d.js";import{n as p,t as m}from"./firebase-DNXHJgUE.js";var h=`wiAudios`,g=`wiImg`,_=()=>r(`wiSmile`)?.email||m.currentUser?.email||``,v=async e=>{let t=_();return t?(await c(f(a(p,e),s(`email`,`==`,t)))).docs.map(e=>({id:e.id,...e.data()})).sort((e,t)=>(t.creado?.seconds||0)-(e.creado?.seconds||0)):[]},y=async(e,t,n)=>{let r=_();return r?(await d(a(p,e),{email:r,titulo:t,src:n,creado:l(),actualizado:l()})).id:null},b=async(e,t)=>{await u(o(p,e,t))},x=()=>v(h),S=()=>v(g),C=(e,n)=>`
