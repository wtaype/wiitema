import{n as e}from"./vendor-BuoCFfzO.js";import{i as t,t as n}from"./wii-BxWTwmKJ.js";import{D as r,S as i,T as a,_ as o,h as s,m as c,r as l,u}from"./widev-DR9cf7O0.js";import{o as d}from"./index-DxvkXVel.js";import{c as f,f as p,m,n as h,o as g,p as _,r as v,s as y,u as b,v as x,y as S}from"./devblog-DgzvYxGj.js";e(`#wiad_styles`).length||e(`<style id="wiad_styles">`).text(`
...
`,w=e=>`<a href="/${e.slug||e.id}" class="po_rel_card" ${a(e.resumen||e.titulo)}><div class="po_rel_img"><img src="${e.imagen}" alt="${e.imagenAlt||e.titulo}" loading="lazy"/></div><div class="po_rel_info"><span class="po_rel_cat"><i class="fas fa-paw"></i> ${e.categoria}</span><strong>${e.titulo}</strong><span class="po_rel_meta"><i class="fas fa-calendar"></i> ${x(e.actualizado||e.creado)} · <i class="fas fa-eye"></i> ${e.vistas||0} · <i class="fas fa-heart" style="color:#fe0149"></i> ${e.likes||0}</span></div></a>`,T=(e,t,n=`po_fade po_visible`)=>e||t?`
    ...
    </div>`:``,E=(e,r,i,s,c)=>{let l=o.user?.usuario,u=c?`po_fade po_visible`:`po_fade`,d=r!==null&&i!==null,f=r||[],p=i||[],m=f[0]||p[0],h=f[1]||p[1],g=d?T(m,h,u):`<div id="po_nav_container"></div>`;return`
      ...
      <div class="po_col_main"><div class="po_content">
        <div class="po_hero ${u}" style="--d:0s">
          ...
          <div class="po_hero_over">
            ...
            <div class="po_hero_badges">
              ...
              <button class="po_like_btn po_like_sync ${localStorage.getItem(`wi_like_`+s)?`active`:``}" data-slug="${s}" ${a(`Me encanta`)} style="border-color:rgba(255,255,255,0.2);background:rgba(0,0,0,0.4);color:#fff;padding:.6vh 1.2vh;font-size:var(--fz_s4)"><i class="fas fa-heart"></i> <span class="po_likes_count_text">${e.likes||0}</span></button>
            </div>
          </div>
        </div>
        <header class="po_header ${u}" style="--d:.1s">
          ...
          <div class="po_meta">
            ...
            <button class="po_like_btn po_like_sync ${localStorage.getItem(`wi_like_`+s)?`active`:``}" data-slug="${s}" ${a(`Me encanta`)}><i class="fas fa-heart"></i> <span class="po_likes_count_text">${e.likes||0}</span></button>
            ${c?`<span class="po_cache_badge" ${a(`Cache ⚡`)}><i class="fas fa-bolt"></i> Local</span>`:``}
          </div>
        </header>
    ...
    <aside class="po_sidebar">
      <div class="po_side_card ${u}" style="--d:.15s">
        ...
        <div class="po_autor_box"><div class="po_autor_av"><img src="/wiitema/v12/smile.avif" alt="${e.autor}"/></div><div class="po_autor_info"><strong>${e.autor}</strong><span>${n} <i class="fas ${t}"></i></span></div></div>
        ${l?`<div class="po_admin_actions" style="margin-top:.8vh"><a href="/nuevo?edit=${s}" class="po_admin_btn_edit" ${a(`Editar`)}><i class="fas fa-pen"></i> Editar</a><button id="po_refresh" class="po_admin_btn_refresh" data-slug="${s}" data-cat="${e.categoria}" ${a(`Recargar`)}><i class="fas fa-rotate"></i></button></div>`:``}
      </div>
