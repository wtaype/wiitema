import{n as e}from"./vendor-BuoCFfzO.js";import{c as t}from"./wii-BxWTwmKJ.js";import{C as n,T as r,_ as i,b as a,n as o,r as s,u as c}from"./widev-CaaaKRDv.js";import{o as l}from"./index-Dg013IOz.js";import{S as u,h as d,p as f,s as p,y as m}from"./firebase-Dw05u4aT.js";import{n as h}from"./firebase-C7Kevfpd.js";import{a as g,b as _,o as v,t as y,u as b}from"./devblog-mtZYmopv.js";var x=e=>e.trim().toLowerCase().normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).replace(/\b(el|la|los|las|de|del|en|un|una|y|a|con|por|para|que|es|se)\b/g,` `).replace(/[^a-z0-9\s]/g,``).replace(/\s+/g,`_`).replace(/_{2,}/g,`_`).replace(/^_|_$/g,``).slice(0,50),S=e=>{let t=e.replace(/<[^>]*>/g,` `).split(/\s+/).filter(Boolean);return{words:t.length,min:Math.max(1,Math.ceil(t.length/200))}},C=()=>a.params()?.edit||new URLSearchParams(location.search).get(`edit`)||null,w=()=>{let e=i.user?.usuario?i.user:c(`wiSmile`)||{};if(!e.email)return`<div class="nu_err dpvc"><i class="fas fa-lock"></i><h2>Acceso restringido</h2><p>Inicia sesión para crear historias</p></div>`;let n=C();return`
  <div class="nu_wrap">
    <div class="nu_head">
...
`)},k=w?`wi_draft_edit_`+t:`wi_draft_new`,A=()=>{let t={titulo:e(`#nu_titulo`).val(),slug:e(`#nu_slug_inp`).val(),resumen:e(`#nu_resumen`).val(),keywords:e(`#nu_keywords`).val(),cat:e(`#nu_cat_inp`).val(),img:e(`#nu_img`).val(),imgTop:e(`#nu_img_top`).val(),content:e(`#nu_contenido`).val(),tags:r};localStorage.setItem(k,JSON.stringify(t))};if(e(`#nu_form`).on(`input`,`input, textarea`,()=>{clearTimeout(window.wiDraftTimer),window.wiDraftTimer=setTimeout(A,1e3)}),(()=>{try{let t=new Set,n=new Set;for(let e of Object.keys(localStorage).filter(e=>e.startsWith(`wi_blogs`)||e.startsWith(`wi_post_`))){let r=c(e);(Array.isArray(r)?r:r?[r]:[]).forEach(e=>{e.categoria&&t.add(e.categoria),e.tags&&Array.isArray(e.tags)&&e.tags.forEach(e=>n.add(e))})}t.size>0&&e(`#nu_cat_sug`).html(Array.from(t).slice(0,8).map(e=>`<span class="nu_sug_chip cat_sug">${e}</span>`).join(``)),n.size>0&&e(`#nu_tag_sug`).html(Array.from(n).slice(0,12).map(e=>`<span class="nu_sug_chip tag_sug">#${e}</span>`).join(``))}catch{console.warn(`No se pudieron cargar sugerencias`)}})(),w)try{let n=await b(t,!0);if(!n?.data){s(`Post no encontrado`,`error`);return}let i=n.data;e(`#nu_titulo`).val(i.titulo),e(`#nu_slug_inp`).val(i.slug||i.id),e(`#nu_resumen`).val(i.resumen||``).trigger(`input`),e(`#nu_keywords`).val(i.keywords||``),e(`#nu_contenido`).val(i.contenidoMd||i.contenido||``),e(`#nu_img`).val(i.imagen||``),e(`#nu_img_top`).val(i.imagenTop||``),e(`#nu_activo`).prop(`checked`,i.activo!==!1),e(`#nu_pin`).prop(`checked`,!!i.pin),e(`#nu_cat_inp`).val(i.categoria||``),r=Array.isArray(i.tags)?[...i.tags]:[],D(),i.imagen&&(e(`#nu_img_el`).attr(`src`,i.imagen),e(`#nu_img_prev`).removeClass(`dpn`)),i.imagenTop&&(e(`#nu_img_top_el`).attr(`src`,i.imagenTop),e(`#nu_img_top_prev`).removeClass(`dpn`)),e(`#nu_resumen_cnt`).text((i.resumen||``).length),E()}catch(e){console.error(`edit load:`,e),s(`Error cargando post`,`error`)}else try{let t=JSON.parse(localStorage.getItem(k));t&&(e(`#nu_titulo`).val(t.titulo),e(`#nu_slug_inp`).val(t.slug),e(`#nu_resumen`).val(t.resumen),e(`#nu_keywords`).val(t.keywords||``),e(`#nu_cat_inp`).val(t.cat),e(`#nu_img`).val(t.img).trigger(`input`),e(`#nu_img_top`).val(t.imgTop).trigger(`input`),e(`#nu_contenido`).val(t.content),t.tags&&(r=t.tags,D()),E())}catch{}e(`#nu_form`).on(`keydown`,e=>{e.key===`Enter`&&e.target.tagName!==`TEXTAREA`&&e.preventDefault()}),w||(e(`#nu_slug_inp`).on(`input`,function(){e(this).val(e(this).val().replace(/[^a-z0-9_]/gi,e=>e===` `?`_`:``).toLowerCase().replace(/_{2,}/g,`_`)),e(`#nu_slug_status`).html(`<i class="fas fa-pen"></i> Escribiendo...`).removeClass(`ok err`)}).on(`change`,async function(){let t=e(this).val(),n=e(`#nu_slug_status`);if(!t)return n.html(``).removeClass(`ok err`);if(t.length<3)return n.html(`<i class="fas fa-exclamation"></i> Muy corto`).addClass(`err`).removeClass(`ok`);n.html(`<i class="fas fa-spinner fa-spin"></i>`).removeClass(`ok err`),(await p(m(h,`blog`,t)).catch(()=>null))?.exists()?n.html(`<i class="fas fa-xmark"></i> Ya existe`).addClass(`err`).removeClass(`ok`):n.html(`<i class="fas fa-check"></i> OK`).addClass(`ok`).removeClass(`err`)}),e(`#nu_slug_reset`).on(`click`,()=>{e(`#nu_slug_inp`).val(T()).trigger(`input`).trigger(`change`)})),e(`#nu_resumen`).on(`input`,function(){e(`#nu_resumen_cnt`).text(e(this).val().length)}),e(`#nu_img`).on(`input`,function(){clearTimeout(a),a=setTimeout(()=>{let t=e(this).val().trim();if(!t)return e(`#nu_img_prev`).addClass(`dpn`);e(`#nu_img_el`).attr(`src`,t).off(`load error`).on(`load`,()=>e(`#nu_img_prev`).removeClass(`dpn`)).on(`error`,()=>e(`#nu_img_prev`).addClass(`dpn`))},600)}),e(`#nu_img_clear`).on(`click`,()=>{e(`#nu_img`).val(``).trigger(`input`),e(`#nu_img_prev`).addClass(`dpn`)});let j;e(`#nu_img_top`).on(`input`,function(){clearTimeout(j),j=setTimeout(()=>{let t=e(this).val().trim();if(!t)return e(`#nu_img_top_prev`).addClass(`dpn`);e(`#nu_img_top_el`).attr(`src`,t).off(`load error`).on(`load`,()=>e(`#nu_img_top_prev`).removeClass(`dpn`)).on(`error`,()=>e(`#nu_img_top_prev`).addClass(`dpn`))},600)}),e(`#nu_img_top_clear`).on(`click`,()=>{e(`#nu_img_top`).val(``).trigger(`input`),e(`#nu_img_top_prev`).addClass(`dpn`)}),e(`#nu_contenido`).on(`input`,E),e(`#nu_tags_inp`).on(`keydown`,function(t){t.key!==`Enter`&&t.key!==`,`||(t.preventDefault(),e(this).val().toLowerCase().split(`,`).map(e=>e.trim().replace(/\s+/g,`_`)).filter(Boolean).forEach(e=>{!r.includes(e)&&r.length<8&&r.push(e)}),D(),e(this).val(``))}),e(document).on(`click.nuevo`,`.nu_tool`,function(){let t=e(this).data(`tag`),n=e(`#nu_contenido`),r=n[0],i=r.selectionStart,a=r.selectionEnd,o=r.value.substring(i,a)||`texto`,s=t.replace(`texto`,o).replace(`cita`,o);n.val(r.value.substring(0,i)+s+r.value.substring(a)),r.focus(),r.selectionStart=i,r.selectionEnd=i+s.length,E(),A()}).on(`click.nuevo`,`.nu_tab`,function(){let t=e(this).data(`tab`);e(`.nu_tab`).removeClass(`active`),e(this).addClass(`active`),t===`prev`?(e(`#nu_prev_html`).html(_(O(e(`#nu_contenido`).val()))).removeClass(`dpn`),e(`#nu_contenido`).addClass(`dpn`)):(e(`#nu_contenido`).removeClass(`dpn`),e(`#nu_prev_html`).addClass(`dpn`))}).on(`click.nuevo`,`.nu_tag_rm`,function(){r.splice(+e(this).data(`i`),1),D()}).on(`click.nuevo`,`.cat_sug`,function(){e(`#nu_cat_inp`).val(e(this).text())}).on(`click.nuevo`,`.tag_sug`,function(){let t=e(this).text().replace(`#`,``);t&&!r.includes(t)&&r.length<8&&(r.push(t),D())}),e(`#nu_form`).on(`submit`,async function(a){a.preventDefault();let b=e(`#nu_submit,.nu_btn_full`),x=i.user?.usuario?i.user:c(`wiSmile`)||{},C=e(`#nu_cat_inp`).val().trim();C&&=C.charAt(0).toUpperCase()+C.slice(1).toLowerCase();let[T,E,D,A,j,M,N,P]=[e(`#nu_titulo`).val().trim(),e(`#nu_resumen`).val().trim(),e(`#nu_keywords`).val().trim(),C,e(`#nu_img`).val().trim(),e(`#nu_img_top`).val().trim(),e(`#nu_contenido`).val().trim(),e(`#nu_slug_inp`).val().trim()],F=_(O(N));if(!T||!E||!A||!j||!N)return s(`Completa los campos obligatorios`,`warning`);if(N.length<10)return s(`Contenido muy corto`,`warning`);if(!P||P.length<3)return s(`Slug inválido`,`warning`);if(!w&&e(`#nu_slug_status`).hasClass(`err`))return s(`Slug no disponible`,`error`);n(b,!0,w?`Guardando...`:`Publicando...`);try{if(`${S(F).min}`,w)await d(m(h,y,t),{activo:e(`#nu_activo`).is(`:checked`),pin:e(`#nu_pin`).is(`:checked`),titulo:T,resumen:E,keywords:D,categoria:A,contenido:F,contenidoMd:N,imagen:j,imagenTop:M,imagenAlt:T,tags:r,tiempoLectura:`${S(F).min} min`,actualizado:u()}),v(t),g(),o(`¡Historia actualizada! 🐾✨`,`success`),setTimeout(()=>l(()=>import(`./index-Dg013IOz.js`).then(e=>e.a).then(e=>e.rutas.navigate(`/${t}`)),[]),1200);else{if((await p(m(h,`blog`,P))).exists())return n(b,!1),s(`Slug existente`,`warning`);await f(m(h,y,P),{id:P,slug:P,activo:e(`#nu_activo`).is(`:checked`),pin:e(`#nu_pin`).is(`:checked`),usuario:x.usuario,email:x.email,autor:x.nombre||x.usuario,titulo:T,resumen:E,keywords:D,categoria:A,contenido:F,contenidoMd:N,imagen:j,imagenTop:M,imagenAlt:T,tags:r,vistas:0,likes:0,tiempoLectura:`${S(F).min} min`,creado:u(),actualizado:u()}),g(),localStorage.removeItem(k),o(`¡Historia publicada! 🐾✨`,`success`),setTimeout(()=>l(()=>import(`./index-Dg013IOz.js`).then(e=>e.a).then(e=>e.rutas.navigate(`/${P}`)),[]),1200)}}catch(e){console.error(`nuevo:`,e),s(w?`Error al guardar`:`Error al publicar`,`error`),n(b,!1)}})},E=()=>{e(`#nu_form,#nu_slug_inp,#nu_titulo,#nu_resumen,#nu_img,#nu_contenido`).off(),e(document).off(`.nuevo`)};export{E as cleanup,T as init,w as render};