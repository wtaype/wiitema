import{n as e}from"./vendor-BuoCFfzO.js";import{t}from"./wii-B7KacVyR.js";import{C as n,S as r,c as i,g as a,h as o,i as s,p as c,r as l,u,v as d}from"./widev-4Rjv6ciq.js";import{i as f}from"./index-Dt5s5XVG.js";var p=`word_docs`,m=()=>`wd`+Date.now(),h=[{id:`ej1`,titulo:`Documento de Ejemplo`,contenido:`<p>Este es un documento de ejemplo. <b>Prueba a editar el texto</b> y usar las herramientas de la barra superior para darle estilo.</p>`,pin:!0,creado:Date.now(),actualizado:Date.now(),synced:!1}],g={get:()=>{let e=localStorage.getItem(p);return e===null&&!a.user?[...h]:u(p)||(e?.startsWith(`[`)?JSON.parse(e):[])},set:e=>c(p,e,8760)},_=()=>`
<div class="wd_wrap">
  <!-- RIBBON -->
