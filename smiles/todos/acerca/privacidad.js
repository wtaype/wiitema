...
const SECCIONES = [
  {
    ...
    body: `<p>Recopilamos lo necesario para la plataforma: cuenta, perfil, plan, temas guardados, preferencias de diseño, historial de descargas y feedback. Datos opcionales incluyen sincronización de proyectos en la nube.</p>`
  },
  {
    ico: 'fa-chart-line', color: '#29C72E', num: '02',
    tit: 'Cómo usamos tu información',
    body: `<p>La usamos para autenticarte, sincronizar tus recursos de diseño guardados, personalizar tu experiencia, aplicar límites por plan, mejorar la plataforma y enviar actualizaciones relevantes cuando lo autorizas.</p>`
  },
  {
    ico: 'fa-globe', color: '#FF5C69', num: '03',
    tit: 'Publicidad y servicios externos',
    body: `<p>Usamos Firebase y servicios de Google para autenticación, Firestore para almacenamiento, Cloud Messaging para notificaciones y análisis técnico cuando corresponda. No utilizamos publicidad invasiva.</p>`
  },
  {
    ico: 'fa-users', color: '#7000FF', num: '04',
    tit: 'Compartir información con terceros',
    body: `<p>No vendemos ni alquilamos tus datos. Solo compartimos información con proveedores necesarios para operar WiiTema (Firebase, Google Cloud). Nunca con terceros comerciales sin consentimiento.</p>`
  },
  {
    ico: 'fa-lock', color: '#FFDA34', num: '05',
    tit: 'Tus derechos',
    body: `<p>Puedes pedir acceso, corrección, descarga o eliminación de tu información escribiendo al equipo. Queremos que tengas control absoluto sobre tus datos de diseño y preferencias.</p>`
  },
  {
    ico: 'fa-user-shield', color: '#0EBEFF', num: '06',
    tit: 'Seguridad',
    body: `<p>Usamos conexiones cifradas (HTTPS), autenticación segura con Google/Firebase y proveedores con estándares modernos. Tus sesiones y tus diseños guardados están protegidos en todo momento.</p>`
  },
];
...
<div class="ac_wrap tm_wrap">
  ...
  <section class="ac_hero tm_hero">
    ...
    <div class="ac_hero_body">
      ...
      <p class="ac_hero_sub">
        <strong>${app}</strong> guarda solo lo necesario para iniciar sesión, sincronizar tus recursos de diseño, aplicar personalizaciones y mejorar la experiencia.
      </p>
