import{n as e}from"./vendor-BuoCFfzO.js";import{t}from"./wii-BxWTwmKJ.js";import{D as n,T as r,i,r as a,u as o}from"./widev-CaaaKRDv.js";import{i as s}from"./index-BVDnJ5oo.js";import{S as c,a as l,c as u,f as d,g as f,l as p,p as m,v as h,y as g}from"./firebase-Dw05u4aT.js";import{n as _,t as v}from"./firebase-C7Kevfpd.js";var y=[],b=null,x=!1,S=null,C=null,w=`wi_mensajes_cache`,T=50,E=()=>o(`wiSmile`)||{},D=e=>{try{localStorage.setItem(w,JSON.stringify(e))}catch{}},O=()=>{try{return JSON.parse(localStorage.getItem(w)||`[]`)}catch{return[]}},k=()=>{let e=document.getElementById(`wmChat`);e&&requestAnimationFrame(()=>e.scrollTop=e.scrollHeight)},A=()=>{let e=E();if(!e.email)return location.replace(`/`),``;let n=e.nombre||e.usuario||e.email||v.currentUser?.email||``;return`
