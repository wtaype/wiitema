import{n as e}from"./vendor-BuoCFfzO.js";import{_ as t}from"./widev-CaaaKRDv.js";import{n}from"./index-Dg013IOz.js";var r=[{href:`/admin`,ico:`fa-globe`,txt:`Centro de Control`,desc:`Consola global de plataforma.`},{href:`/usuarios`,ico:`fa-users`,txt:`Gestión de Usuarios`,desc:`Control de cuentas y moderación.`},{href:`/sistema`,ico:`fa-cogs`,txt:`Sistema y Logs`,desc:`Estado del sistema y bases de datos.`},{href:`/gestor`,ico:`fa-users-gear`,txt:`Dashboard Gestor`,desc:`Administración de ventas.`},{href:`/smile`,ico:`fa-gauge-high`,txt:`Dashboard Colaborador`,desc:`Métricas y retos del mes.`},{href:`/crear`,ico:`fa-plus-circle`,txt:`Mis Linkwiis`,desc:`Administra tus enlaces cortos.`},{href:`/agregar`,ico:`fa-folder-plus`,txt:`Mis Recursos`,desc:`Gestiona archivos y carpetas.`},{href:`/win`,ico:`fa-file-shield`,txt:`wiWin Cloud`,desc:`Almacenamiento en la nube.`},{href:`/word`,ico:`fa-file-lines`,txt:`Word Editor`,desc:`Editor de documentos.`},{href:`/notas`,ico:`fa-book`,txt:`Notas Book`,desc:`Cuaderno de notas rápidas.`},{href:`/chat`,ico:`fa-comments`,txt:`Chat Grupal`,desc:`Mensajería interna del equipo.`},{href:`/mensajes`,ico:`fa-envelope`,txt:`Mensajes`,desc:`Buzón de notificaciones.`},{href:`/perfil`,ico:`fa-user-gear`,txt:`Mi Perfil`,desc:`Ajustes de cuenta y temas.`},{href:`/nuevo`,ico:`fa-pen-to-square`,txt:`Crear Post`,desc:`Escribe artículos del blog.`}],i=()=>{let e=t.user;if(!e)return`<div class="z_page"><div class="z_empty"><i class="fas fa-ban"></i> Acceso denegado.</div></div>`;let i=e.rol||`admin`;return`
    <div class="z_wrap">
    ...
    `).join(``)||`<div class="z_empty_grid">No hay herramientas disponibles para tu rol.</div>`}
      </div>
    </div>
  `},a=()=>{t.user&&(e(document).off(`.zmasss`).on(`input.zmasss`,`#zSearchInput`,function(){let t=e(this).val().toLowerCase().trim();if(!t){e(`.z_card`).show();return}e(`.z_card`).each(function(){let n=e(this).attr(`data-search`)||``;e(this).toggle(n.includes(t))})}),e(`.wi_fadeUp`).addClass(`visible wi_visible`),window.__WIREADY__=!0)},o=()=>{e(document).off(`.zmasss`)};export{o as cleanup,a as init,i as render};