import{n as e}from"./vendor-BuoCFfzO.js";import{t}from"./wii-B7KacVyR.js";import{D as n,T as r,i,r as a,u as o}from"./widev-C6_C1nMz.js";import{i as s}from"./index-vmHpfrLD.js";import{_ as c,b as l,d as u,g as d,m as f,o as p,r as m,s as h,u as g}from"./firebase-CcGrcE7k.js";import{n as _,t as v}from"./firebase-Dp4rAqD-.js";var y=[],b=null,x=!1,S=null,C=null,w=`wi_mensajes_cache`,T=50,E=()=>o(`wiSmile`)||{},D=e=>{try{localStorage.setItem(w,JSON.stringify(e))}catch{}},O=()=>{try{return JSON.parse(localStorage.getItem(w)||`[]`)}catch{return[]}},k=()=>{let e=document.getElementById(`wmChat`);e&&requestAnimationFrame(()=>e.scrollTop=e.scrollHeight)},A=()=>{let e=E();if(!e.email)return location.replace(`/`),``;let n=e.nombre||e.usuario||e.email||v.currentUser?.email||``;return`
