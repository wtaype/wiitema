...
.wi_premium_title {
  ...
  transition: all var(--tr_m);
    ...
    `).join(``);t.html(i)},f=()=>{let e=a(`wiSmile`)||{},n=e.nombre||e.usuario||e.email||``;return`
